					...
					<table id="myTable" class="table table-bordered table-sm" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th style = "width:16%; font-size: 14px">Project Cost</th>
								<th style = "width:16%; font-size: 14px">Payment ID</th>
							</tr>
						</thead>
						<?php
						...
						<tbody>
							...
							<tr>
								...
								<td><?php  echo $row['payment_cost'] ?></td>
								<td style = "color:white"><?php  echo $row['payment_id']; ?>
                                <center><div>
										<input type="submit" name="paymentviewer" value=<?php  echo $row['payment_id']; ?> style="background-color:white; border:none; color: blue; position:relative; bottom:14px">
									</div></center>
								</td>
							</tr>
                            <?php } ?>
