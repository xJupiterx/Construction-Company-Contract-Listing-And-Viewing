...
<body>
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="card">
				<div class="card-header" style="background-color: #869aba; color:white"><strong><center>List of Client Information</center></strong></div>
				<?php
				...
				<form class="table-responsive" method='post' style = "height: 410px; overflow: scroll">
					<table id="myTable" class="table table-bordered table-sm" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th style = "width:16%; font-size: 14px">Client Name</th>
								<th style = "width:16%; font-size: 14px">Mailing Street Address</th>
								<th style = "width:16%; font-size: 14px">City</th>
								<th style = "width:16%; font-size: 14px">Telephone</th>
								<th style = "width:16%; font-size: 14px">Email</th>
								<th style = "width:16%; font-size: 14px">Client ID</th>
							</tr>
						</thead>
						<?php
						...
						<tbody>
							<tr>
								...
								<td><?php  echo $row['client_cpno']; ?></td>
								<td><?php  echo $row['client_email']; ?></td>
								<td style = "color:white"><?php  echo $row['client_id']; ?>
                                <center><div>
										<input type="submit" name="clientviewer" value=<?php  echo $row['client_id']; ?> style="background-color:white; border:none; color: blue; position:relative; bottom:14px">
									</div></center>
								</td>
							</tr>
						<?php
