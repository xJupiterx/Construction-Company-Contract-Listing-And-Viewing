...
<body>
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="card">
				<div class="card-header" style="background-color: #869aba; color:white"><strong><center>List of Project Information</center></strong></div>
				<?php
				...
				<form class="table-responsive" method='post' style = "height: 410px; overflow: scroll">
					<table id="myTable" class="table table-bordered table-sm" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th style = "width:16%; font-size: 14px">Project Name</th>
								<th style = "width:16%; font-size: 14px">Project Address</th>
								<th style = "width:16%; font-size: 14px">Type of Project</th>
								<th style = "width:16%; font-size: 14px">Budget</th>
								<th style = "width:16%; font-size: 14px">Desired Duration</th>
								<th style = "width:16%; font-size: 14px">Project ID</th>
							</tr>
						</thead>
						<?php
						...
						<tbody>
							<?php 
							$accountName = $_SESSION['lastname'] . ', ' . $_SESSION['firstname'];
							if($row['owner_name'] == $accountName){
							?>
								<tr>
									<td><?php  echo $row['proj_name'] ?></td>
									<td><?php  echo $row['proj_address'] ?></td>
									<td><?php  echo $row['proj_type']; ?></td>
									<td><?php  echo $row['budget']; ?></td>
									<td><?php  echo $row['start_date']; ?> - <?php  echo $row['end_date']; ?></td>
									<td style = "color:white"><?php  echo $row['project_id']; ?>
									<center><div>
											<input type="submit" name="projectviewer" value=<?php  echo $row['project_id']; ?> style="background-color:white; border:none; color: blue; position:relative; bottom:14px">
										</div></center>
									</td>
								</tr>
							<?php } ?>
