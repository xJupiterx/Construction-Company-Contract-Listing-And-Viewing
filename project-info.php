        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <center><div class="page-title">
                    <h3>View Project Complete Information</h3>
                </div></center>
                <br>
                <section class="col-md-12">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #869aba">
                            <h4 class="card-title" style="color: white; font-size: 28px"><strong>Project Details</strong></h4>
                        </div>
                        <form class="card-body px-0 pb-0" method='post'>
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['proj_name'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['proj_address'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['proj_type'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['proj_desc'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
								<?php $money = number_format($_SESSION['budget']) ?>
                                    <p id = 'text5'> ₱ <?php echo $money ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-4'>
                                    <p id = 'text5' style = 'width:302px'> <?php echo $_SESSION['start_date'] ?></p>
                                </div>
                                <div class='col-md-4'>
                                    <p id = 'text5' style = 'width:267px; position:relative; right: 22px'> <?php echo $_SESSION['end_date'] ?></p>
                                </div>
                            </div>
                            <br>
                            <div class='row'>
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['ce_name'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['ce_cpno'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['ce_email'] ?></p>
                                </div>
                            </div>
                            <br>
                            <div class='row'>
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['a_name'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['a_cpno'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['a_email'] ?></p>
                                </div>
                            </div>
                            <br>
                            <div class='row'>
                            ...
                            <div class='row'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['c_name'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['c_cpno'] ?></p>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <p id = 'text5'> <?php echo $_SESSION['c_email'] ?></p>
                                </div>
                            </div>
                            <br>
                            <div class="card-footer" style="background-color: #869aba; position:relative; height:30px">
                                <a style="color: white; font-size:14px; position:relative; bottom:3px" href='project-info-edit.php'><center>Click <u>here</u> to edit Information.</center></a>
                            </div>
                        </form></center>
                    </div>
                </section>
