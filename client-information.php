                ...
                <div class="page-title">
                    <div class = 'row'>
                        ...
                        <div class = 'col-md-4'>
                            <div class = 'row'>
                                <div class = 'col-md-4'>
                                <center><a href ='client-information.php'><u>Client Information</u></a></center>
                                </div>
                                <div class = 'col-md-4'>
                ...
                <section class="col-md-12">
                        ...
                        <form class="card-body px-0 pb-0" method = 'post'>
                            <div class='row'>
                                ...
                                <div class='col-md-8'>
                                    <input id = 'textbox10' type="text" name="client_name" placeholder="" required>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <input id = 'textbox10' type="text" name="client_address" placeholder="" required>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <input id = 'textbox10' type="text" name="city" placeholder="" required>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <input id = 'textbox10' type="text" name="client_cpno" placeholder="" required>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-8'>
                                    <input id = 'textbox10' type="text" name="client_email" placeholder="" required>
                                </div>
                            </div>
                            <br>
                            <div class='row'>
                            ...
                            <br>
                            <div class="clearfix">
                                <input class="btn btn-primary float-end" id = 'buttonSize' type="submit" name="add_client" value="ADD DATA" style = 'margin-right:385px'> 
                            </div>
                            <br>
                        </form></center>
                    </div>
