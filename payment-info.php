                ...
                <section class="col-md-12">
                        ...
                        <form class="card-body px-0 pb-0" method = 'post'>
                            ...
                            <div class='row'>
                                ...
                                <?php $money = number_format($_SESSION['payment_cost']) ?>
                                <div class='col-md-8'>
                            ...
                            <?php if($_SESSION[$paymentcounter] > 0){ ?>
                                <div class = 'row'>
                                    ...
                                    <div class = 'col-md-4'>
                                        <?php $money = number_format($_SESSION[$paymentcounter]) ?>
                                        <p id = 'text4'>₱ <?php echo $money ?></p>
                                    </div>
                                    <div class = 'col-md-4'>
                                        <?php $money = number_format($total) ?>
                                        <p id = 'text4'>₱ <?php echo $money ?><p>
                                    </div>
                                </div>
                            <?php $i = intval($i);
                            ...
                            <div class = 'row'>
                                ...
                                <div class = 'col-md-4'>
                                <?php $money = number_format($amountpaid) ?>
                                    <p id = 'text4'>Total Amount Paid: ₱ <?php echo $money ?></p>
                                </div>
                                <div class = 'col-md-4'>
                                <?php $money = number_format($total) ?>
                                    <p id = 'text4'>Balance: ₱ <?php echo $money ?><p>
                                </div>
                            </div>
                        ...
                        <center><form class="card" style = " width:75%;background-color:#869aba" method = 'post'>
                            <div class="card-header align-items-center" style="background-color: #869aba">
                                <h4 class="card-title" style="color: white; font-size: 28px"><strong>Add Payment</strong></h4>
                            </div>
                            <div class = 'row' style = 'position:relative; left:24px'>
                                <div class = 'col-md-4'>
                                    <input id = 'textbox10' type="date" name="date3" required style = 'width:100%'>
                                </div>
                                <div class = 'col-md-4'>
                                    <input id = 'textbox10' type="text" name="payment3" required style = 'width:100%' placeholder="Enter Amount">
                                </div>
                            </div>
                            <div class="clearfix">
                                <input class="btn btn-primary float-end" id = 'buttonSize1' type="submit" name="update_payment" value="ADD PAYMENT" style = 'margin-right:65px'> 
                            </div>
                        </form>
                    </div>
                </section>
